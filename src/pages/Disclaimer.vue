        ...
        <div class="wrap-featured page-layout">
          <div class="feature">
            ...
            <p>
              ...
              there are a variety of unforeseeable risks. You acknowledge and
              agree that there are numerous risks associated with acquiring
              Local token, holding Local token, and using Local token for
              participation in Local Terra. In the worst scenario, this could
              ...
              time. The Local Terra team has neither the ability nor obligation
              ...
              Local Terra, which could negatively affect Local token and/or
              Local Terra. Further, the future of cryptography and security
    ...
    <footer class="section-spacer">
      <div class="wrap-footer page-layout">
        ...
        <div class="social">
          ...
          <a href="https://github.com/Local-Terra" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
